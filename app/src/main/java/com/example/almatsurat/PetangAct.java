...
import com.example.almatsurat.Adapter.AdapterPetang;

public class PetangAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //membinding viewPager ke layout activity_Petang.xml agar bisa di slide
        viewPager = findViewById(R.id.petang);

        //mengirimkan data ke AdapterPetang dengan data dri string[]
        adapter = new AdapterPetang(PetangAct.this,judul,arab,terjemahan);
